...
DISCOVERY_MAX_VERIFY_DEFAULT = 30   # Р3.1: верхних кандидатов в верификацию за сутки
...
TENURE_DAYS = 14               # Р2-БИС.2(б): непрерывный сбор для промоушена
...
CLASSIFY_DAILY_CAP = 400           # Р1.5: дневной потолок Tuber-x, постов
